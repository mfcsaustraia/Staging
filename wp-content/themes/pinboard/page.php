	...
	<div id="content" class="clearfix">
		...
		if($themify->query_category != ""): ?>
			...
			<?php if(themify_get('section_categories') != 'yes'): ?>
				...
				<?php query_posts(apply_filters('themify_query_posts_page_args', 'cat='.$themify->query_category.'&posts_per_page='.$themify->posts_per_page.'&paged='.$themify->paged)); ?>
					...
					<?php if(have_posts()): ?>
						...
						<!-- loops-wrapper -->
						<div class="loops-wrapper infinite-scrolling AutoWidthElement">
			...
			<?php else: ?>
				...
				<?php
 query_posts(apply_filters('themify_query_posts_page_args', 'cat='.$cat->cat_ID.'&posts_per_page='.$themify->posts_per_page.'&paged='.$themify->paged));	?>

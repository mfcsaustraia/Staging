...
function themify_add_multisite_menu() {
	if( current_user_can('manage_network_options') && is_main_site() )
		add_submenu_page('themify', __( 'Multisite Setup', 'themify' ), __( 'Multisite Setup', 'themify' ), 'manage_options', 'themify_multisite', 'themify_multisite_ui' );
}
...
/* Add menu entry */
add_action('admin_menu', 'themify_add_multisite_menu');

...
<div class="gh_tabs_div_inner">
					...
					<div class="row-fluid-outer">
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								<input type="radio" name="thanks_page_chat" value="1" <?php if($thanks_page_chat=='1' || $thanks_page_chat==''){ echo 'checked'; } ?>> Yes &nbsp;&nbsp; <input type="radio" name="thanks_page_chat" value="0" <?php if($thanks_page_chat=='0'){ echo 'checked'; }?>> No
                            </div>
                        </div>
...
<?php } ?>
                        <!--
                        <div id="myMenu10" class="gh_accordian_tab"><i class="icon-plus-sign"></i> Clock Design </div>
						<div id="myDiv10" class="gh_accordian_div">
                           <div class="row-fluid-outer">
                        <div class="row-fluid">
							<div class="span4">
                            ...
                            <div class="span8">
								<div class="row-fluid">
                                    ...
                                    <input type="radio" name="thankyou_timer_type" <?php //if($thankyou_timer_type=='1'){ echo 'checked="checked"'; }?> value="1">
                                    <img src="<?php //echo plugin_dir_url(__FILE__);?>images/timer1.JPG" alt=""/>
                                    </div>
                                    </div>
                                    <div class="span4">
                                    <div class="gh_img_full">
                                    <input type="radio" name="thankyou_timer_type" <?php //if($thankyou_timer_type=='2'){ echo 'checked="checked"'; }?> value="2">
                                    <img src="<?php //echo plugin_dir_url(__FILE__);?>images/timer2.JPG" alt=""/>
                                    </div>
                                    </div>
                                    <div class="span4">
                                    <div class="gh_img_full">
                                    <input type="radio" name="thankyou_timer_type" <?php //if($thankyou_timer_type=='3'){ echo 'checked="checked"'; }?> value="3">
					...
					?>
						...
						<div id="myDiv11" class="gh_accordian_div">
							...
							<div class="row-fluid">
								<div class="span4">
									<strong>Sidebar Box Sub Heading </strong>
								</div>
								<div class="span8">
									<input type="text"  class="longinput" name="thanks_sidebar_sub_title" size="50" Value="<?php //echo get_post_meta( $hangout_id, 'thanks_sidebar_sub_title', true); ?>" />
								</div>
							</div>
							</div>
							...
							<div class="row-fluid">
								<div class="span4">
									<strong>Sidebar Box Image  </strong>
								</div>
								<div class="span8">
									<input type="file" name="thanks_sidebar_image"/>&nbsp;
									<?php //if(get_post_meta( $hangout_id, 'thanks_sidebar_image', true)!=''){ ?>
									<br><img src="<?php //echo get_post_meta( $hangout_id, 'thanks_sidebar_image', true); ?>" style="width:100px; height:100px;">
									<?php //} ?>
								</div>
							</div>
							</div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								<input id="ghanghout_thankyou_enable_header" name="ghanghout_thankyou_enable_header" size="30" value="checked" type="checkbox" <?php if($ghanghout_thankyou_enable_header=="checked"){ echo 'checked="checked"'; } ?> > Enable Logo &nbsp;&nbsp;<!--<input id="ghanghout_thankyou_enable_sharing" name="ghanghout_thankyou_enable_sharing" size="30" value="checked" type="checkbox" <?php //if($ghanghout_thankyou_enable_sharing=="checked"){ echo 'checked="checked"'; } ?>> Enable Social Sharing -->
							</div>
                        </div>
                        </div>
                        <div class="row-fluid-outer">

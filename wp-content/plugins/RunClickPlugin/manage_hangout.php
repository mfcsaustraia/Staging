		...
		<div class="row-fluid">
    		...
    		<div class="span6">
            	<div class="block_right">
					...
					Chat <?php if(get_option("hangout_chat_settings",true) == "0"){ ?> <img src="<?php echo plugin_dir_url(__FILE__);?>images/activated.png" alt="" align="top" />
					<?php }else{?>
	...
	<script src="<?php echo plugin_dir_url(__FILE__);?>/js/lightbox-2.6.min.js"></script>
                     <script type="text/javascript">
								...
								jQuery('.hangout_status').live('click',function(){
									...
									jQuery.ajax({
										type: 'POST',
										url: '<?php echo plugins_url()?>/RunClickPlugin/hangout_status.php',
...
<?php if(isset($_REQUEST['selected_type'])){
					...
					<?php $plugins_url = plugin_dir_url(__FILE__);
						...
						if(($hangout_selected_type=='' || $hangout_selected_type=='New_hangout')  && ($hangout_type=='New_hangout' || $hangout_type=='' )) {
								...
								<li id="hangouts_dashboard_7"><a href="#vote" >Vote And Pop up</a></li>

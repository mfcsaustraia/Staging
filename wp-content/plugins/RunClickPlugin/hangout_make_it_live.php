...
<div class="gh_tabs_div_inner">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								<input type="text" name="hangout_youtube" id="hangout_youtube" value="<?php echo $post_id; ?>" readonly />
                            </div>
                        </div>
                        </div>
						<?php 
					...
					?>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								...
								<a id="start_ghangout" class="ghangout" href="https://plus.google.com/hangouts/_?gid=<?php echo get_option('g_project_id'); ?>" style="text-decoration:none;"> <img src="https://ssl.gstatic.com/s2/oz/images/stars/hangout/1/gplus-hangout-15x79-normal.png" alt="Start a Hangout" /> <!-- <img src="<?php echo plugins_url();?>/HangoutPlugin/images/google-hangouts-logo.jpg" alt="Start a Hangout"/> --> </a>
								<?php }else{ ?>
								<a id="start_ghangout" class="ghangout" href="https://plus.google.com/hangouts/_?hso=0&gid=<?php echo get_option('g_project_id'); ?>" style="text-decoration:none;"> <img src="https://ssl.gstatic.com/s2/oz/images/stars/hangout/1/gplus-hangout-15x79-normal.png" alt="Start a Hangout" /> <!-- <img src="<?php echo plugins_url();?>/HangoutPlugin/images/google-hangouts-logo.jpg" alt="Start a Hangout"/> --> </a>
                            	<?php }?>
                            </div>
                        </div>
                        </div>
                        <?php if(get_post_meta($_REQUEST['EID'],'hangout_public_private',true) != "private"){ ?>
                        <div class="row-fluid-outer" style="display:none;" id="get_youtube_details_cointainer">
                        <div class="row-fluid">
							<div class="span12">
								<a href="#" id="get_youtube_details"> Click here To get Youtube Webinar details </a>
                            </div>
                        </div>
						</div>
						<div class="row-fluid-outer">
                        ...
                        <div class="row-fluid">
							<div class="span4">
								<strong>Youtube Embeded Code</strong>
                            </div>
                            <div class="span8">
								<input type="hidden" name="hangout_youtube_src" id="hangout_youtube_src" value="<?php //echo $yousrc; ?>" />
								<textarea name="g_embeded_code" cols="50" rows="5" id="hangout_emb_code"><?php //echo $youembed; ?></textarea></span>
                            </div>
                        </div>
                        </div>-->
						<!--<div class="row-fluid-outer">
						...
						<div class="row-fluid-outer">
		                    <div class="row-fluid">
		                        ...
		                        <div class="span8">
		                        	<textarea name="buybuttonhtml" id="buybuttonhtml"><?php echo $buybuttonhtml;?></textarea>
		                        </div>
		                    </div>
		                </div>
						</div>
					...
					?>					
						...
						<div id="liveoption1layout" <?php if($g_hangout_make_live_layout_type==2){ echo 'style="display:none;"'; } ?>>
						 <div class="row-fluid-outer">
                        <div class="row-fluid">

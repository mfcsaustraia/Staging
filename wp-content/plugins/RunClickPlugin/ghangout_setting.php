			...
			<form class="hangouts_form" enctype="multipart/form-data" action="" method="post">
						...
						*/ ?>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								<input class="chat-setup" type="radio" value="0" name="hangout_chat_settings" <?php if($hangout_chat_settings == "0"){ echo "checked='checked'";} ?>> Yes
								<input class="chat-setup" type="radio" value="1" name="hangout_chat_settings" <?php if($hangout_chat_settings == "1" || $hangout_chat_settings == ""){ echo "checked='checked'";} ?>> No 

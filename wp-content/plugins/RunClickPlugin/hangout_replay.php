...
if(isset($_POST['edit_replay_hangout'])){
	...
	$post_id = $_REQUEST['hangout_id'];
		...
		//update_post_meta($post_id,"hangout_timezone_start_date",$_POST["hangout_timezone_start_date"]);
		//update_post_meta($post_id,"hangout_timezone_end_date",$_POST["hangout_timezone_end_date"]);
		...
		//update_post_meta($post_id,"hangout_limit_replay_option",$_POST["hangout_limit_replay_option"]);
		/* Option 1 end values*/
		//update_post_meta($post_id,"ghanghout_replay_timer_position",$_POST["ghanghout_replay_timer_position"]);
		if($banner_name !=''){
...
$g_hangout_layout_type = '';
	...
	$hangout_show_replay = $hangout_lock_replay =1 ;
	
		/* Option 1 end values*/
	//$ghanghout_replay_timer_position = get_post_meta($post_id,"ghanghout_replay_timer_position",true);
...
if(isset($_REQUEST['EID'])){
	...
	//$start_timezone = get_post_meta($post_id,'hangout_timezone_start_date',true);
	//$end_timezone = get_post_meta($post_id,'hangout_timezone_end_date',true);
	...
	//$hangout_limit_replay_option = get_post_meta($post_id,"hangout_limit_replay_option",true);
...
<div class="gh_tabs_div_inner">
					...
					?>
						...
						<?php } ?>
						<?php /*
						<div class="row-fluid-outer limit_replay_option">
                        <div class="row-fluid">
							<div class="span4">
								<strong>Limit Replay </strong>
                            </div>
                            <div class="span8">
								<input type="radio" name="hangout_limit_replay_option" value="1" <?php if($hangout_limit_replay_option == '1'){ echo "checked='checked'";}?> />&nbsp;Yes &nbsp;&nbsp;
								<input type="radio" name="hangout_limit_replay_option" value="0" <?php if($hangout_limit_replay_option == '0' || $hangout_limit_replay_option == ""){ echo "checked='checked'";}?> />&nbsp;No
                            </div>
                        </div>
                        </div>
					
						<div class="row-fluid-outer replay_option">
                        <div class="row-fluid">
							<div class="span4">
								<strong>Start Date </strong>
                            </div>
                            <div class="span8">
								<input type="text" class="longinput" name="hangout_timezone_start_date" id="hangout_timezone_start_date" value="<?php echo $start_timezone; ?>" /></span>
                            </div>
                        </div>
                        </div> 
                        <div class="row-fluid-outer replay_option">
                        <div class="row-fluid">
                            ...
                            <div class="span8">
							<input class="longinput" type="text" name="hangout_timezone_end_date" id="ghangout_end_timezone" value="<?php echo $end_timezone; ?>" />
					...
					?>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span8">
								<input type="radio" name="hangout_lock_replay" value="1" <?php if($hangout_lock_replay==1 || $hangout_lock_replay==''){ echo 'checked="checked"'; } ?>/> Yes &nbsp;&nbsp; 
								<input type="radio" name="hangout_lock_replay" value="0" <?php if($hangout_lock_replay==0){ echo 'checked="checked"'; } ?>/> No
                            </div>
                        </div>
                        </div>
					<?php }  /* ?>	
                        ...
                        <div class="row-fluid">
							<div class="span4">
								<strong>Chat Turn Off at registration page design </strong>
                            </div>
                            <div class="span8">
                        ...
                        <div class="row-fluid">
							<div class="span4">
								<strong>Chat Turn On at make live  </strong>
                            </div>
                            <div class="span8">
								<input type="radio" name="chat_make_off_replay" value="1" <?php if($chat_make_off_replay==1 || $chat_make_off_replay==''){ echo 'checked="checked"'; } ?>/> Yes &nbsp;&nbsp; <input type="radio" name="chat_make_off_replay" value="0" <?php if($hangout_lock_replay==0){ echo 'checked="checked"'; } ?>/> No
                                </div>
                            </div>
                        </div>
						<?php */ ?>
                        ...
                        <div id="myMenu14" class="gh_accordian_tab"><i class="icon-plus-sign"></i> Clock Design </div>
						<div id="myDiv14" class="gh_accordian_div">
                        <div class="row-fluid-outer">
                        <div class="row-fluid">
							<div class="span4">
                            ...
                            <div class="span8">
								<div class="row-fluid">
                                    ...
                                    <input type="radio" name="replay_timer_type" <?php if($replay_timer_type=='1'){ echo 'checked="checked"'; }?> value="1">
                                    <img src="<?php echo plugin_dir_url(__FILE__);?>images/timer1.JPG" alt=""/>
                                    </div>
                                    </div>
                                    <div class="span4">
                                    <div class="gh_img_full">
									<input type="radio" name="replay_timer_type" value="2" <?php if($replay_timer_type=='2'){ echo 'checked="checked"'; }?>>

                                    <img src="<?php echo $base_path; ?>images/timer2.JPG" alt=""/>
                                    </div>
                                    </div>
                                    <div class="span4">
                                    <div class="gh_img_full">
                                    <input type="radio" name="replay_timer_type" value="3" <?php if($replay_timer_type=='3'){ echo 'checked="checked"'; }?>>
                                    <img src="<?php echo $base_path; ?>images/timer3.JPG" alt=""/>
                                    </div>
                                    </div>
                                </div>
                            </div>
					...
					?>
                        ...
                        <div id="replayoption1layout" <?php if($g_hangout_replan_layout_type==2){ echo 'style="display:none;"'; } ?>>
						 <div class="row-fluid-outer">
                        <div class="row-fluid">
							...
							<div class="span6">
							<input type="radio" name="ghanghout_replay_timer_position"  value="top" <?php //if($ghanghout_replay_timer_position=='' || $ghanghout_replay_timer_position == "top")echo 'checked="checked"';?>> Top &nbsp;&nbsp;
							<input type="radio" name="ghanghout_replay_timer_position"  value="bottom" <?php //if($ghanghout_replay_timer_position == "bottom")echo 'checked="checked"';?>> Bottom
							</div>
							</div>
							</div>-->
                        </div>

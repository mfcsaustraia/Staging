...
$message = str_replace("{sitename}",$sitename,$message);
		...
		$result=$wpdb->get_results('SELECT email, name,add_email from '. $subscriber_table.' where g_event_id="'.$post->ID.'"');

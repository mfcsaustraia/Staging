...
if($end>$now){
	...
	$form .= '<link rel="Stylesheet" type="text/css" href="'.plugin_dir_url( __FILE__ ).'css/main.css"></link><div id="ghanout_event_timer"  >';
		...
		$form	.=	"<div class='clear'></div><br/ ><p>".get_post_meta($post->ID,"hangout_timezone",true)." ".get_post_meta($post->ID,"hangout_time_zone",true)." <a href='http://www.timeanddate.com/worldclock/fixedtime.html?msg=".str_replace(" ","+",get_the_title())."&iso=".$hangout_event_date."T".$hangout_event_time."&p1=".$tz."' target='_blank'>Check Time Zone Here</a></p>";	

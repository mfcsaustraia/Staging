...
<div class="title_line">
	<div class="view_title"><span style="margin-right:10px"><?php _e("Need Premium Support and Auto Updates ?") ?></span><a style="vertical-align:middle" class='button-primary revblue' href='#' id="benefitsbutton"><?php _e("Why is this Important ?", EG_TEXTDOMAIN)?> </a></div>
</div>
...
<div id="benefitscontent" style="margin-top:10px;margin-bottom:10px;display:none;border:1px solid #e5e5e5; padding:15px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background-color:#fff;">		
	...
	<p>
	<strong><?php _e("Get Premium Support"); ?></strong><?php _e(" - We help you in case of Bugs, installation problems, and Conflicts with other plugins and Themes ", EG_TEXTDOMAIN); ?><br>
	<strong><?php _e("Auto Updates"); ?></strong><?php _e(" - Get the latest version of our Plugin.  New Features and Bug Fixes are available regularly !", EG_TEXTDOMAIN); ?>
	</p>
</div>
...
<div id="tp-validation-box" style="cursor:pointer;border:1px solid #e5e5e5; margin-top:10px;padding:15px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background:#f1f1f1">		
	...
	<div id="rs-validation-wrapper" style="display:<?php echo $displ; ?>">
		...
		<div class="validation-input">
			<input type="text" name="eg-validation-token" value="<?php echo $code; ?>" <?php echo ($validated === 'true') ? ' readonly="readonly"' : ''; ?> placeholder="45afeb91-0e4c-a1d9-2a4a-04ce3b5a3b30" style="width: 350px;" />
			<p class="validation-description"><?php _e('Please enter your '); ?><strong style="color:#000"><?php _e('CodeCanyon Essential Grid purchase code / license key'); ?></strong><?php _e('. You can find your key by following the instructions on'); ?><a target="_blank" href="http://www.themepunch.com/home/plugins/wordpress-plugins/revolution-slider-wordpress/where-to-find-the-purchase-code/"><?php _e(' this page.', EG_TEXTDOMAIN); ?></a></p>
		</div>
		<div class="clear"></div>
	...
	<?php if($validated === 'true') {
		...
		<p>
		<?php _e("Please feel free to contact us via our ")?><a href='http://themepunch.ticksy.com'><?php _e("Support Forum ")?></a><?php _e("and/or via the ")?><a href='http://codecanyon.net/item/tp_eg_pro-responsive-teaser-wordpress-plugin/4720988'><?php _e("Item Disscussion Forum", EG_TEXTDOMAIN)?></a><br />
		</p> 	
		<?php 	
	} else {
		?> 
		...
		<?php _e("Click Here to get "); ?><strong><?php _e("Premium Support and Auto Updates", EG_TEXTDOMAIN); ?></strong><br />
